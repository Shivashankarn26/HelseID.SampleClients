...
using Clients;
using MvcCoreHybridBackChannel.Models;

namespace MvcCoreHybridBackChannel.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> RenewTokens()
        {
            ...
            var tokenClient = new TokenClient(disco.TokenEndpoint, "mvc.core.hybridbackchannel", "secret");
